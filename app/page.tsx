...
export default function Dashboard() {
  ...
  return (
    <div className="flex-1 space-y-4 overflow-auto p-3 md:p-6">
      {/* Key Metrics */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-4 md:mb-6">
        ...
        <Card>
          ...
          <CardContent className="px-4 md:px-6">
            <div className="text-xl md:text-2xl font-bold">{stats?.serviceDue || 0}</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-4 md:px-6 pt-4 md:pt-6">
            <CardTitle className="text-xs md:text-sm font-medium">Asset Value</CardTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6 mb-4 md:mb-6">
        ...
        <Card>
          <CardHeader className="px-4 md:px-6">
            <CardTitle className="text-base md:text-lg">Equipment Status Distribution</CardTitle>
          </CardHeader>
          <CardContent className="px-4 md:px-6">
        ...
        <Card>
          <CardHeader className="px-4 md:px-6">
            <CardTitle className="text-base md:text-lg">Equipment by Department</CardTitle>
          </CardHeader>
          <CardContent className="px-4 md:px-6">
            <div className="h-[450px] md:h-[350px] flex justify-center">
              <div className="w-full">
                <BarChartComponent
                  labels={departmentData.map((item: any) => item.department)}
                  datasets={[
                    {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6 mb-4 md:mb-6">
        ...
        <Card>
          <CardHeader className="px-4 md:px-6">
            <CardTitle className="text-base md:text-lg">Maintenance Trends</CardTitle>
          </CardHeader>
          <CardContent className="px-4 md:px-6">
            <div className="h-[280px] md:h-[300px]">
              <LineChartComponent
                ...
                datasets={[
                  {
                    label: "Completed",
                    data: maintenanceTrendData.map((item) => item.completed),
                    borderColor: "#22c55e",
                  },
                  {
                    label: "Scheduled",
                    data: maintenanceTrendData.map((item) => item.scheduled),
                    borderColor: "#3b82f6",
                  },
                ]}
              />
        ...
        <Card>
          <CardHeader className="px-4 md:px-6">
            <CardTitle className="text-base md:text-lg">Upcoming Maintenance</CardTitle>
          </CardHeader>
          <CardContent className="px-4 md:px-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">
                        {item.manufacturer && item.model
                          ? `${item.manufacturer} - ${item.model}`
                          : item.manufacturer || item.model || "Not Specified"}
                      </div>
                    </div>
